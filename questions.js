...
var SUBJECT_DATA = {
  ...
  fluid_mechanics: {
    ...
    questions: [
      ...
      { id: 56, question: "The velocity of a fluid particle at the center of the pipe section is______.", options: ["Maximum", "Minimum", "Average", "Logarithmic average"], answer: 0, explanation: "• Why 'Maximum' is Correct: Maximum velocity occurs at pipe centerline.\n• Why Other Choices differ: Alternative options (Minimum, Average, Logarithmic average) do not satisfy the required governing physical principles or mathematical relations for this specific problem condition." },
